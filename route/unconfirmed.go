...
func SetupUnconfirmedCRUD[T interface{}](r *gin.Engine, db *tigris.Database, name string) {
	setupUnconfirmedReadRoute[T](r, db, name)
	setupUnconfirmedSearchRoute[T](r, db, name)
...
func setupUnconfirmedReadRoute[T interface{}](r *gin.Engine, db *tigris.Database, name string) {
...
func setupUnconfirmedSearchRoute[T interface{}](r *gin.Engine, db *tigris.Database, name string) {
